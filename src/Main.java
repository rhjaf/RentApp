...
public class Main {
    ...
    private static void displayAvailableCars(BookingService carBookingService, boolean isElectric) {
        List<Car> availableCars = isElectric ? carBookingService.getAvailableElectricalCars() : carBookingService.getAvailableCars();
    ...
    private static void allBookings(BookingService carBookingService) {
        List<Booking> bookings = carBookingService.getBookings();
        if (bookings.isEmpty()) {
